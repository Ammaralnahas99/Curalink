...
@NamedQuery(
        ...
        query = "select new org.curalink.arc.entity.Series$MetadataUpdate(" +
...
@NamedQuery(
        ...
        query = "select new org.curalink.arc.entity.Series$StorageVerification(" +
...
@NamedQuery(
        ...
        query = "select new org.curalink.arc.entity.Series$Compression(" +
