...
package org.curalink.arc.entity;
...
import static org.curalink.data.PersonName.Component;
import static org.curalink.data.PersonName.Group;
...
public class PersonName {
    ...
    public PersonName(org.curalink.data.PersonName pn, FuzzyStr fuzzyStr) {
        fromDicom(pn, fuzzyStr);
    }

    private void fromDicom(org.curalink.data.PersonName pn, FuzzyStr fuzzyStr) {
    ...
    public org.curalink.data.PersonName toPersonName() {
        org.curalink.data.PersonName pn = new org.curalink.data.PersonName();
    ...
    public static PersonName valueOf(String s, FuzzyStr fuzzyStr,
        ...
        org.curalink.data.PersonName pn = new org.curalink.data.PersonName(s,
                true);
        if (pn.isEmpty())
            return null;
