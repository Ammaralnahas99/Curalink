 ...
 */
@Entity
@Table(name = "instance_req", indexes = {
...
public class InstanceRequestAttributes {
    ...
    public InstanceRequestAttributes() {}

    public InstanceRequestAttributes(Attributes attrs, FuzzyStr fuzzyStr) {
