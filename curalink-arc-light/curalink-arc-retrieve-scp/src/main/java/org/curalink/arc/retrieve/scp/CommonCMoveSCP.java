...
package org.curalink.arc.retrieve.scp;
...
import org.curalink.arc.retrieve.scu.CMoveSCU;
...
class CommonCMoveSCP extends BasicCMoveSCP {
    ...
    protected RetrieveTask calculateMatches(Association as, PresentationContext pc, Attributes rq, Attributes keys)
        ...
        QueryRetrieveLevel2 qrLevel = QueryRetrieveLevel2.validateRetrieveIdentifier(keys, qrLevels,
                queryOpts.contains(QueryOption.RELATIONAL), relationalRetrieveNegotiationLenient(as));
