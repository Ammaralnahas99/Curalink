...
import org.curalink.imageio.codec.ImageReaderFactory;
import org.curalink.imageio.codec.ImageWriterFactory;
...
import org.curalink.net.audit.AuditRecordRepository;
import org.curalink.net.audit.AuditSuppressCriteria;
import org.curalink.net.hl7.HL7Application;
import org.curalink.net.hl7.HL7DeviceExtension;
import org.curalink.net.imageio.ImageReaderExtension;
import org.curalink.net.imageio.ImageWriterExtension;
   ...
   static final QueryRetrieveView IOCM_DISABLED_VIEW =
    ...
    public static Device createArchiveDevice(String name, ConfigType configType, Device arrDevice,
        ...
        WebApplication webapp = createWebApp("DCM4CHEE", AE_TITLE_DESC,
                ...
                WebApplication.ServiceClass.CURALINK_ARC_AET);
        device.addWebApplication(webapp);
        ...
        device.addWebApplication(createWebApp("dcm4chee-arc", "Forward Reschedule Task(s)",
                ...
                WebApplication.ServiceClass.CURALINK_ARC));
        return device;
    }
    ...
    private static void addArchiveDeviceExtension(Device device, ConfigType configType,
        ...
        device.addDeviceExtension(ext);
        ext.setFuzzyAlgorithmClass("org.curalink.soundex.ESoundex");
