...
import org.curalink.io.DicomInputStream;
...
import org.curalink.arc.conf.AttributeSet;
...
import org.curalink.arc.query.util.QIDO;
...
import org.curalink.arc.rs.util.MediaTypeUtils;
...
public class QidoRS {
    ...
    public Response sizeOfStudies() {
        ...
        if (aet.equals(ae.getAETitle()))
            validateWebAppServiceClass(WebApplication.ServiceClass.CURALINK_ARC_AET);
