...
package org.curalink.arc.hl7.psu;
...
import org.curalink.arc.conf.HL7PSUAction;
...
public class HL7PSUEJB {
    ...
    private static final String HL7PSU_RESULTS_STORED_PRELIMINARY = "P";
    ...
    private String resultStatus(Series series) {
        ...
        switch (rejectionState) {
            ...
            default:
                return HL7PSU_RESULTS_STORED_PRELIMINARY;
        }
    }
