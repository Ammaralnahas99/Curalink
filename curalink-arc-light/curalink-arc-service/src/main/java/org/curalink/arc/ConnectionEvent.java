...
public class ConnectionEvent {
    ...
    public enum Type {
        ESTABLISHED, FAILED, REJECTED, REJECTED_BLACKLISTED, ACCEPTED
    }
    ...
    private ConnectionEvent(Type type, Connection connection, Connection remoteConnection, Socket socket,
                           Throwable exception) {
        this.type = type;
