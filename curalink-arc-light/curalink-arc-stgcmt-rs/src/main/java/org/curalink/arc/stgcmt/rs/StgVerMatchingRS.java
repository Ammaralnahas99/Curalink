...
import org.curalink.arc.conf.StorageVerificationPolicy;
...
import org.curalink.arc.qmgt.TaskManager;
...
import org.curalink.arc.stgcmt.StgCmtManager;
    ...
    private void validateWebAppServiceClass() {
        device.getWebApplications().stream()
                ...
                .orElseThrow(() -> new WebApplicationException(
                        ...
                        "No Web Application with CURALINK_ARC_AET service class found for Application Entity: "
                                + aet)));
    }
