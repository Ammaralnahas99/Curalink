...
package org.curalink.arc.conf.ldap;

import jakarta.enterprise.context.ApplicationScoped;
import org.curalink.arc.conf.*;
import org.curalink.conf.api.ConfigurationChanges;
import org.curalink.conf.api.ConfigurationException;
import org.curalink.conf.ldap.LdapDicomConfiguration;
import org.curalink.conf.ldap.LdapDicomConfigurationExtension;
import org.curalink.conf.ldap.LdapUtils;
import org.curalink.data.Issuer;
import org.curalink.data.VR;
import org.curalink.data.ValueSelector;
import org.curalink.deident.DeIdentifier;
import org.curalink.net.ApplicationEntity;
...
import org.curalink.util.Property;
...
public class LdapArchiveConfiguration extends LdapDicomConfigurationExtension {
    ...
    protected void storeTo(ConfigurationChanges.ModifiedObject ldapObj, Device device, Attributes attrs) {
        ...
        LdapUtils.storeNotNullOrDef(ldapObj, attrs, "dcmCopyMoveUpdatePolicy",
                ext.getCopyMoveUpdatePolicy(), org.curalink.data.Attributes.UpdatePolicy.PRESERVE);
        LdapUtils.storeNotNullOrDef(ldapObj, attrs, "dcmLinkMWLEntryUpdatePolicy",
                ext.getLinkMWLEntryUpdatePolicy(), org.curalink.data.Attributes.UpdatePolicy.PRESERVE);
        ...
        LdapUtils.storeNotDef(ldapObj, attrs, "dcmInExpressionCountLimit",
                ext.getInExpressionCountLimit(), 1000);
        ...
        LdapUtils.storeNotNullOrDef(ldapObj, attrs, "fhirDefaultSystemOfAccessionNumber",
                ext.getFhirDefaultSystemOfAccessionNumber(), null);
        LdapUtils.storeNotEmpty(ldapObj, attrs, "fhirSystemOfPatientID",
                ext.getFhirSystemOfPatientID());
        LdapUtils.storeNotEmpty(ldapObj, attrs, "fhirSystemOfAccessionNumber",
                ext.getFhirSystemOfAccessionNumber());
        LdapUtils.storeNotEmpty(ldapObj, attrs, "fhirSystemByIssuerOfPatientID",
    ...
    protected void loadFrom(Device device, Attributes attrs) throws NamingException {
        ...
        ext.setCopyMoveUpdatePolicy(
                LdapUtils.enumValue(org.curalink.data.Attributes.UpdatePolicy.class,
                        attrs.get("dcmCopyMoveUpdatePolicy"), org.curalink.data.Attributes.UpdatePolicy.PRESERVE));
        ext.setLinkMWLEntryUpdatePolicy(
                LdapUtils.enumValue(org.curalink.data.Attributes.UpdatePolicy.class,
                        attrs.get("dcmLinkMWLEntryUpdatePolicy"), org.curalink.data.Attributes.UpdatePolicy.PRESERVE));
        ...
        ext.setInExpressionCountLimit(LdapUtils.intValue(attrs.get("dcmInExpressionCountLimit"), 1000));
        ...
        ext.setFhirSystemOfPatientID(LdapUtils.enumArray(
                ArchiveDeviceExtension.FHIRSystemFromDICOMIssuer.class, attrs.get("fhirSystemOfPatientID")));
        ext.setFhirSystemOfAccessionNumber(LdapUtils.enumArray(
    ...
    protected void storeDiffs(ConfigurationChanges.ModifiedObject ldapObj, Device prev, Device device, List<ModificationItem> mods) {
        ...
        LdapUtils.storeDiffObject(ldapObj, mods, "dcmCopyMoveUpdatePolicy",
                ...
                org.curalink.data.Attributes.UpdatePolicy.PRESERVE);
        ...
        LdapUtils.storeDiff(ldapObj, mods, "dcmInExpressionCountLimit",
                aa.getInExpressionCountLimit(), bb.getInExpressionCountLimit(), 1000);
        ...
        LdapUtils.storeDiffObject(ldapObj, mods, "fhirDefaultSystemOfPatientID",
                ...
                null);
        LdapUtils.storeDiffObject(ldapObj, mods, "fhirDefaultSystemOfAccessionNumber",
                aa.getFhirDefaultSystemOfAccessionNumber(),
                bb.getFhirDefaultSystemOfAccessionNumber(),
                null);
    ...
    private static Attributes storeTo(ConfigurationChanges.ModifiedObject ldapObj, AttributeFilter filter, Entity entity,  BasicAttributes attrs) {
        ...
        LdapUtils.storeNotNullOrDef(ldapObj, attrs, "dcmAttributeUpdatePolicy",
                filter.getAttributeUpdatePolicy(), org.curalink.data.Attributes.UpdatePolicy.PRESERVE);
        return attrs;
    }
    ...
    private Attributes storeTo(ConfigurationChanges.ModifiedObject ldapObj, ArchiveAttributeCoercion coercion, BasicAttributes attrs) {
        ...
        LdapUtils.storeNotNullOrDef(ldapObj, attrs, "dcmAttributeUpdatePolicy",
                coercion.getAttributeUpdatePolicy(), org.curalink.data.Attributes.UpdatePolicy.MERGE);
    ...
    private void loadAttributeCoercions(Collection<ArchiveAttributeCoercion> coercions, String parentDN, Device device)
        ...
        try {
            while (ne.hasMore()) {
                ...
                coercion.setAttributeUpdatePolicy(LdapUtils.enumValue(org.curalink.data.Attributes.UpdatePolicy.class,
                        attrs.get("dcmAttributeUpdatePolicy"), org.curalink.data.Attributes.UpdatePolicy.MERGE));
    ...
    private List<ModificationItem> storeDiffs(
        ...
        LdapUtils.storeDiffObject(ldapObj, mods, "dcmAttributeUpdatePolicy",
                ...
                org.curalink.data.Attributes.UpdatePolicy.MERGE);
