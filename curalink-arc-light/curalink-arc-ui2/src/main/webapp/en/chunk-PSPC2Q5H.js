import { AppRequestsService, FormControl, FormGroup, FormGroupDirective, FormsModule, MatProgressSpinner, NG_VALUE_ACCESSOR, NgControl, NgForm, OrderByPipe, PermissionService, Validators } from "./chunk-U5B6VCCX.js";
...
var ControlService = (_a11 = class {
  ...
  getUrl(url, mode) {
    if (url) {
      return `${this.removeSlashOnTheEndOfUrl(url)}${this.appService.baseUrl}ctrl/${mode}`.replace(`${this.appService.baseUrl}${this.appService.baseUrl}`, this.appService.baseUrl);
    } else {
