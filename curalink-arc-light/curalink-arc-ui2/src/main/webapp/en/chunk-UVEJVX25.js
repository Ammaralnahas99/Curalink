import { TableService } from "./chunk-PRR3EG3M.js";
import { DevicesService, TableSchemaElement } from "./chunk-PSPC2Q5H.js";
import { MessagingComponent } from "./chunk-3CW7OVXR.js";
import { AppRequestsService, PermissionService } from "./chunk-U5B6VCCX.js";
...
\r
    <!-- User Info Section -->\r
    <li class="user-info" *ngIf="mainservice.user && mainservice.user.user && mainservice.user.user != 'anonymous'">\r
        <div class="user-profile">\r
            <i class="material-icons user-icon">account_circle</i>\r
            <div class="user-details">\r
                <span class="user-name">{{ mainservice.user.user }}</span>\r
                <span class="user-role" *ngIf="mainservice.user.realm">{{ mainservice.user.realm }}</span>\r
            </div>\r
        </div>\r
    </li>\r
\r
