    ...
    ngOnInit() {
        ...
        this.route.params.subscribe(params => {
            ...
            setTimeout(() => {
                ...
                /*                    if(this.studyConfig.tab === "diff"){
                                        this.currentWebAppClass = "CURALINK_ARC_AET_DIFF";
                                    }else{
...
<br>\nSuccessful: ${res.length - errorCount}:successful:`);
    ...
    * */
                ...
                if (!environment.production) {
                    ...
                    /*
                                        res = [{
                                            ...
                                            "77770010": {"vr": "LO", "Value": ["Curalink Archive"]},
        ...
        return value.filter(option => {
            if (option.value === "create_patient"
                ...
                return studyConfig && studyConfig.tab === "patient"
                    && this.service.webAppGroupHasClass(this.studyWebService, "CURALINK_ARC_AET")
            } else {
    ...
    setMainSchema() {
        ...
        const showSize: boolean = _.hasIn(this.studyWebService, "selectedWebService.dcmWebServiceClass") && this.studyWebService.selectedWebService.dcmWebServiceClass.indexOf("CURALINK_ARC_AET") > -1;
        ...
        this.service.getPatientIod().subscribe((iod) => {
            ...
            this.dialogRef.afterClosed().subscribe(result => {
                if (result) {
                    ...
                    if (mode === "create") {
                        this.service.modifyPatient(undefined, tempAttrs, this.studyWebService, undefined, undefined, additionalParams).subscribe(res => {
            ...
            .subscribe((res) => {
                ...
                $this.dialogRef.afterClosed().subscribe(ok => {
                    if (ok) {
                        ...
                        let params = ok.sourceOfPrevVals != '' && ok.sourceOfPrevVals != undefined
            ...
            if (result) {
                ...
                if (mode === "multiple-retrieve") {
                    this.service.getWebAppFromWebServiceClassAndSelectedWebApp(
                        ...
                        if (webApp) {
                            urlRest = `${j4care.getUrlFromDcmWebApplication(webApp, this.appService.baseUrl)
                                }/studies/export/dicom:${result.selectedAet
                                }?${params1
                    ...
                    if (mode === 'multipleExportSelections') {
                        this.service.getWebAppFromWebServiceClassAndSelectedWebApp(
                            ...
                            if (webApp) {
                                urlRest = `${this.service.getDicomURL("export", webApp)
                        ...
                        if (!this.internal) {
                            this.service.getWebAppFromWebServiceClassAndSelectedWebApp(
                                ...
                                if (webApp) {
                                    ...
                                    this.appService.showError($localize`:@@webapp_with_web_service_class_not_found:Web Application Service with the web service class ${'MOVE,CURALINK_ARC_AET'} not found!`)
                                }
                                fireService(result, multipleObjects, singleUrlSuffix, urlRest, url);
                            });
                        } else {
...
`,
    ...
    openExternalViewer() {
        window.open('https://alhayahscan.nextasolutions.net:8888/viewer/?id=portal&password=portal15113030#/viewer?accessionnumber=', '_blank');
    }
