...
describe('j4care', () => {
    ...
    it("Should return whole URL from DcmWebApp",()=>{
                ...
                new DcmWebApp(
                    {
                        ...
                        dicomDescription: "Hide instances rejected for Quality Reasons",
                        dcmWebServicePath: "/curalink/aets/DCM4CHEE/rs",
                        dcmWebServiceClass: [
                            "WADO_RS",
                            "STOW_RS",
                            "QIDO_RS",
        ...
        ).toEqual(`/curalink/aets/DCM4CHEE/rs`);
        ...
        ).toEqual(`http://127.0.0.1:2575/curalink/aets/DCM4CHEE/rs`);
    ...
    it("Should map devices to SelectDropdown", ()=>{
        expect(j4care.mapDevicesToDropdown([
            new Device({
                "dicomDeviceName": "curalink-arc",
                "dicomManufacturer": "dcm4che.org",
                "dicomManufacturerModelName": "curalink-arc",
