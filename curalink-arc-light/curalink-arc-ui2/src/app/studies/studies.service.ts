            ...
            if((externalInternalAetMode === 'external' && modifyMode === 'edit') || externalInternalAetMode === 'internal'){
                    return {
                        save:this.$http.put(
                            ...
                            // .map(res => {let resjson; try{ let pattern = new RegExp("[^:]*:\/\/[^\/]*\/auth\/"); if(pattern.exec(res.url)){ WindowRefService.nativeWindow.location = "/curalink/ui2/";} resjson = res; }catch (e){ resjson = [];} return resjson;}),
                            ,
...
/*    isTargetInClipboard(target, clipboard){
    ...
    queryNationalPationtRegister(patientID){
        // return of([{"00081190":{"vr":"UR","Value":["http://shefki-lifebook:8080/curalink/aets/DCM4CHEE/rs"]},"00100010":{"vr":"PN","Value":[{"Alphabetic":"test12SELAM"}]},"00100020":{"vr":"LO","Value":["pid1"]},"00100040":{"vr":"CS","Value":["F"]},"00201200":{"vr":"IS","Value":[0]},"77770010":{"vr":"LO","Value":["Curalink Archive"]},"77771010":{"vr":"DT","Value":["20180315123826.668"]},"77771011":{"vr":"DT","Value":["20180315125113.826"]}}]);
