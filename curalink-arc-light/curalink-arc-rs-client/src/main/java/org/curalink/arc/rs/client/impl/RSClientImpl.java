...
package org.curalink.arc.rs.client.impl;
...
import org.curalink.arc.rs.client.RSClient;
...
public class RSClientImpl implements RSClient {
    ...
    private String targetURL(RSOperation rsOp, String requestURL, WebApplication webApplication, String patientID) {
        try {
            if (webApplication.containsServiceClass(WebApplication.ServiceClass.CURALINK_ARC_AET)) {
