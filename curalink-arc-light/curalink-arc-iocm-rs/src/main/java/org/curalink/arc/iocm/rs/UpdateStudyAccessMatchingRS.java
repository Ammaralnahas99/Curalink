...
import org.curalink.arc.update.UpdateService;
...
public class UpdateStudyAccessMatchingRS {
    ...
    private org.curalink.arc.query.util.QueryParam queryParam(ApplicationEntity ae, String storeAccessControlID) {
