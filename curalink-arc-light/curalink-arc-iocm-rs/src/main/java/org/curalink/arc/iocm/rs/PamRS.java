...
import org.curalink.arc.patient.*;
import org.curalink.audit.AuditMessages;
import org.curalink.conf.api.ConfigurationException;
import org.curalink.conf.api.ConfigurationNotFoundException;
import org.curalink.conf.api.hl7.IHL7ApplicationCache;
import org.curalink.data.*;
import org.curalink.json.JSONReader;
import org.curalink.dict.archive.PrivateTag;
import org.curalink.net.ApplicationEntity;
import org.curalink.net.Device;
import org.curalink.net.Priority;
import org.curalink.net.WebApplication;
import org.curalink.net.hl7.HL7Application;
import org.curalink.net.hl7.HL7DeviceExtension;
import org.curalink.net.service.DicomServiceException;
import org.curalink.util.AttributesFormat;
import org.curalink.util.StringUtils;
import org.curalink.arc.conf.AllowDeletePatient;
import org.curalink.arc.conf.ArchiveAEExtension;
import org.curalink.arc.conf.ArchiveDeviceExtension;
import org.curalink.arc.conf.RSOperation;
import org.curalink.arc.delete.DeletionService;
import org.curalink.arc.delete.StudyDeletionInProgressException;
import org.curalink.arc.delete.StudyNotEmptyException;
import org.curalink.arc.entity.AttributesBlob;
import org.curalink.arc.entity.Patient;
import org.curalink.arc.entity.PatientID;
import org.curalink.arc.hl7.HL7Sender;
import org.curalink.arc.hl7.HL7SenderUtils;
import org.curalink.arc.id.IDService;
import org.curalink.arc.keycloak.HttpServletRequestInfo;
import org.curalink.arc.keycloak.KeycloakContext;
import org.curalink.arc.patient.*;
import org.curalink.arc.query.QueryService;
import org.curalink.arc.query.scu.CFindSCU;
import org.curalink.arc.query.util.QueryAttributes;
import org.curalink.arc.rs.client.RSForward;
import org.curalink.arc.validation.constraints.InvokeValidate;
...
public class PamRS {
    ...
    private org.curalink.arc.query.util.QueryParam queryParam(ApplicationEntity ae, boolean withoutIssuer) {
        org.curalink.arc.query.util.QueryParam queryParam = new org.curalink.arc.query.util.QueryParam(ae);
    ...
    private void validateWebAppServiceClass() {
        device.getWebApplications().stream()
                .filter(webApp -> request.getRequestURI().startsWith(webApp.getServicePath())
                        ...
                        .contains(WebApplication.ServiceClass.CURALINK_ARC_AET))
                .findFirst()
                .orElseThrow(() -> new WebApplicationException(errResponse(
                        "No Web Application with CURALINK_ARC_AET service class found for Application Entity: " + aet,
                        Response.Status.NOT_FOUND)));
    }
        ...
        try {
            ...
            StreamingOutput output = out -> {
                try (JsonGenerator gen = Json.createGenerator(out)) {
                    ...
                    org.curalink.arc.query.util.QueryParam queryParam = new org.curalink.arc.query.util.QueryParam(
