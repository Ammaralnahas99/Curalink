...
package org.curalink.arc.conf.json;

import jakarta.enterprise.context.ApplicationScoped;
import jakarta.json.stream.JsonParser;
import org.curalink.arc.conf.*;
import org.curalink.conf.api.ConfigurationException;
import org.curalink.conf.json.ConfigurationDelegate;
import org.curalink.conf.json.JsonConfigurationExtension;
import org.curalink.conf.json.JsonReader;
...
public class JsonArchiveConfiguration extends JsonConfigurationExtension {
    ...
    protected void storeTo(Device device, JsonWriter writer) {
        ...
        writer.writeNotEmpty("hl7PSUAction", arcDev.getHL7PSUAction());
    ...
    protected void storeTo(ApplicationEntity ae, JsonWriter writer) {
        ...
        writer.writeNotEmpty("hl7PSUAction", arcAE.getHL7PSUAction());
        ...
        while (reader.next() == JsonParser.Event.KEY_NAME) {
            switch (reader.getString()) {
                ...
                case "hl7PSUReceivingApplication":
                    ...
                    break;
                case "hl7PSUAction":
                    arcDev.setHL7PSUAction(reader.enumArray(HL7PSUAction.class));
                    break;
                case "hl7PSUTrigger":
        ...
        while (reader.next() == JsonParser.Event.KEY_NAME) {
            switch (reader.getString()) {
                ...
                case "hl7PSUReceivingApplication":
                    ...
                    break;
                case "hl7PSUAction":
                    arcAE.setHL7PSUAction(reader.enumArray(HL7PSUAction.class));
                    break;
                case "hl7PSUTrigger":
