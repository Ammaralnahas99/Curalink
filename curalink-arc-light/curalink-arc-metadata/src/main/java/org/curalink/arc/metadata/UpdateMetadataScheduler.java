...
package org.curalink.arc.metadata;
...
import org.curalink.conf.api.DicomConfiguration;
import org.curalink.data.Attributes;
import org.curalink.data.DatePrecision;
import org.curalink.data.Tag;
import org.curalink.data.VR;
import org.curalink.dict.archive.PrivateTag;
import org.curalink.json.JSONWriter;
import org.curalink.util.DateUtils;
import org.curalink.util.StringUtils;
import org.curalink.util.UIDUtils;
import org.curalink.arc.ArchiveService;
import org.curalink.arc.Scheduler;
import org.curalink.arc.conf.ArchiveDeviceExtension;
import org.curalink.arc.conf.Duration;
import org.curalink.arc.conf.LocationStatus;
import org.curalink.arc.entity.Location;
import org.curalink.arc.entity.Metadata;
import org.curalink.arc.entity.Series;
import org.curalink.arc.entity.UIDMap;
import org.curalink.arc.event.SoftwareConfiguration;
import org.curalink.arc.retrieve.RetrieveContext;
import org.curalink.arc.retrieve.RetrieveService;
import org.curalink.arc.retrieve.SeriesInfo;
import org.curalink.arc.retrieve.StudyInfo;
import org.curalink.arc.storage.Storage;
import org.curalink.arc.storage.StorageFactory;
import org.curalink.arc.storage.WriteContext;
import org.curalink.arc.store.InstanceLocations;
...
public class UpdateMetadataScheduler extends Scheduler {
    ...
    private Attributes loadMetadata(RetrieveContext ctx, InstanceLocations match) throws Exception {
        return match.isContainsMetadata() ? match.getAttributes()
                : coerceSeriesMetadata(ctx, match, retrieveService.loadMetadata(ctx, match));
    }
    ...
    private Attributes coerceSeriesMetadata(RetrieveContext ctx, InstanceLocations inst, Attributes attrs) {
