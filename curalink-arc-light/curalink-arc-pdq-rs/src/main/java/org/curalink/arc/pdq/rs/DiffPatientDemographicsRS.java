...
package org.curalink.arc.pdq.rs;
...
import org.curalink.arc.conf.Entity;
import org.curalink.arc.conf.PDQServiceDescriptor;
...
import org.curalink.arc.pdq.PDQService;
import org.curalink.arc.pdq.PDQServiceContext;
import org.curalink.arc.pdq.PDQServiceException;
import org.curalink.arc.pdq.PDQServiceFactory;
    ...
    private void validateWebAppServiceClass() {
        device.getWebApplications().stream()
                .filter(webApp -> request.getRequestURI().startsWith(webApp.getServicePath())
                        ...
                        .contains(WebApplication.ServiceClass.CURALINK_ARC_AET_DIFF))
                .findFirst()
                .orElseThrow(() -> new WebApplicationException(errResponse(
                        "No Web Application with CURALINK_ARC_AET_DIFF service class found for Application Entity: " + aet,
